...
* Tomcat can handle 1200 QPS per instance, DB can handle 500 QPS no problem. For cache, more often than not is the bandwidth than QPS. By default tomcat's connection pool size = 1000
